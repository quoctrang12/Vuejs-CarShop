            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input v-model="this.data.email" type="text" class="form-control rounded-0"
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input v-model="this.data.address" type="text" class="form-control rounded-0"
                        id="floatingInput" placeholder="">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input v-model="this.data.account.password" type="text" class="form-control rounded-0"
                        id="floatingInput" placeholder="">
      ...
      <table class="table table-light table-hover text-center">
        ...
        <tbody>
          <tr v-for="(e,i) in this.users">
            ...
            <td><button type="button" class="btn btn-outline-dark me-1 px-2 rounded-0">
