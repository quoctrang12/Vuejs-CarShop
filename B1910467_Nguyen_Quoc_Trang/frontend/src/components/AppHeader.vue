    ...
    <div class="logo">
      ...
      <div class="row m-0 align-items-center">
        ...
        <div v-else class="col-sm-12 col-md-5 col-lg-3 user-login text-end">
          <div class="user">
            <i class="far fa-user text-dark"></i>
            <router-link to="/login" class="ms-2 text-dark fw-bold">Sign In</router-link>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          <ul class="navbar-nav" style="font-size: 18px;">
            ...
            <li class="nav-item me-4">
              <router-link class="nav-link text-black" to="/product">PRODUCT</router-link>
            </li>
            <li class="nav-item me-4">
              <router-link class="nav-link text-black" to="/about">COLLECTION 2022</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link text-black" to="/order">ORDERS
              </router-link>
            </li>
          </ul>
        </div>
